...
public class DatasetAdapter extends TypeAdapter<Dataset> {
    ...
    public Dataset read(JsonReader reader) throws IOException {
        ...
        Gson gson = new Gson();
        Type mapToken = new TypeToken<Map<String, Value>>() {
                }.getType();
        ...
        while (reader.hasNext()) {
            ...
            if (token.equals(JsonToken.NAME)) {
                ...
                /*
                 * } else if ("_id".equals(fieldname)) { token=reader.peek(); try { Object myInt
                 * = reader.nextInt(); _dataset.setId(myInt.toString()); } catch
                 * (IllegalStateException exception) { reader.skipValue(); }
                 */
    ...
    @Override
    public void write(JsonWriter writer, Dataset value)
        throws IOException {
        if (value == null) {
            writer.nullValue();
        ...
        writer.name("definition")
              .value(gson.toJson(value.getDefinition(), Definition.class));
